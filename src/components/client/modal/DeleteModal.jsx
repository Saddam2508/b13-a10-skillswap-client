...
export function DeleteModal({ task, isOpen, onClose, onConfirm, deleting }) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="sm">
      <Modal.Content className="bg-zinc-900 border border-zinc-800 rounded-2xl text-center">
        <Modal.Body className="py-8 flex flex-col items-center gap-3">
          ...
          <div>
            <p className="text-white font-semibold text-base">Delete Task?</p>
